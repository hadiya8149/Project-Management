        ...
        <div className='card card-login m-auto'>
          ...
          <div className='card-body login'>
            ...
            <div className="mb-3 text-align-left">
                <label htmlFor="InputEmail" id="emailLabel" className="form-label">Name</label>
                <input type="text" style={{ padding:'8px', background:'#eef5fd54'}} placeholder='John Doe' className="form-control" id="InputEmail" aria-describedby="emailHelp" />
              </div>
              <div className="mb-3 text-align-left">
              ...
              <div className="mb-3 text-align-left">
                <label htmlFor="passwordConfirmation" id="passwordLabel" className="form-label">Re-enter password</label>
                <input type="password"  style={{background:'#eef5fd54'}} className="form-control" id="passwordConfirmation" />
              </div>
              <div className="mb-3 form-check">
                <Link className='forgot-password-link' to='forgot_password'>Forgot Password?</Link>
              </div>
              <button type="submit" className="btn btn-light signin">Sign up</button>
